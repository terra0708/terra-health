    ...
    return (
        <Box sx={{ animation: 'fadeIn 0.6s ease', pb: 4 }}>
            ...
            <Grid container spacing={3}>
                {/* SOL LİSTE (Masaüstünde görünür, mobilde sadece showDetail false iken) */}
                {(!isMobile || !showDetail) && (
                ...
                {/* SAĞ DETAY (Masaüstünde görünür, mobilde sadece showDetail true iken) */}
                {(!isMobile || showDetail) && (
...
const CreateDrawer = ({ open, onClose, type, formData, setFormData, theme, t, isMobile }) => {
    const isDark = theme.palette.mode === 'dark';
    return (
        <Drawer
