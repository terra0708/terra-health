            ...
            <Table sx={{ minWidth: 1200 }}>
                <TableHead>
                    <TableRow sx={{ bgcolor: alpha(theme.palette.primary.main, 0.02) }}>
                        <TableCell sx={{ pl: 3, fontWeight: 800, fontSize: '0.7rem', color: 'text.secondary' }}>{t('customers.registration_date').toUpperCase()}</TableCell>
                        ...
                        <TableCell align="right" sx={{ pr: 3, fontWeight: 800, fontSize: '0.7rem', color: 'text.secondary' }}>{t('common.actions').toUpperCase()}</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {customers.map((c) => (
